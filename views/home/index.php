    ...
    <div class="col-md-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <a class="btn btn-dark" href="/pizzaria/Client/menu.php">Voir le menu</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <a class="btn btn-dark" href="/pizzaria/Client/composer.php">Composer</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <a class="btn btn-dark" href="/pizzaria/Client/cart.php">Panier</a>
            </div>
        </div>
    </div>
</div>
