...
<?php if (empty($_SESSION['cart'])): ?>
    <div class="alert alert-info">Votre panier est vide. <a href="/pizzaria/Client/menu.php">Voir le menu</a></div>
<?php else: ?>
    <div class="card">
        <div class="card-body">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="text-muted small">
                                        <?= h($item['type'] === 'custom' ? 'Personnalisée' : 'Menu') ?></div>
                                </td>
                                ...
                                <td class="text-end">
                                    <form method="post" class="d-flex justify-content-end gap-2">
                                        ...
                                        <input type="number" name="qty" class="form-control" style="max-width:90px" min="0"
                                            value="<?= (int) $qty ?>">
            ...
            <div class="d-grid mt-3">
                <a class="btn btn-dark btn-lg" href="/pizzaria/Client/checkout.php">Commander</a>
            </div>
        </div>
    </div>
<?php endif; ?>
