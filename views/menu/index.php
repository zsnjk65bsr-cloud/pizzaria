...
<div class="d-flex align-items-center justify-content-between mb-3">
    ...
    <a class="btn btn-outline-dark" href="cart.php">Voir panier (<?= number_format(cart_total(), 2) ?> DT)</a>
</div>
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card h-100">
                <?php if (!empty($p['image'])): ?>
                    <img class="card-img-top" alt="<?= h($p['nom']) ?>" src="assets/images/<?= h($p['image']) ?>">
                <?php else: ?>
                    <div class="card-img-top bg-light d-flex align-items-center justify-content-center text-muted">No image</div>
                <?php endif; ?>
